...
SELECT name FROM countries WHERE code IN (SELECT countrycode FROM countrylanguages WHERE language = 'Italian' AND isofficial = TRUE);
...
world=# SELECT countrycode FROM cities WHERE name = 'Serra';
